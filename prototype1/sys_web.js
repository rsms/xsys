...
// enum sys_opcode
const sys_op_init  = 0 // sys_callback f, void* userdata
const sys_op_test  = 1 // sys_opcode op
const sys_op_exit  = 2 // int status_code
const sys_op_open  = 3 // const char* path, usize flags, isize mode
...
function sys_syscall(proc, op, arg1, arg2, arg3, arg4, arg5) { // -> sys_ret
  ...
  switch (op) {
    case sys_op_init:  return sys_syscall_init(proc, arg1, arg2, arg3, arg4, arg5);
    case sys_op_test:  return sys_syscall_test(proc, arg1, arg2, arg3, arg4, arg5);
    case sys_op_exit:  return sys_syscall_exit(proc, arg1, arg2, arg3, arg4, arg5);
    case sys_op_open:  return sys_syscall_open(proc, arg1, arg2, arg3, arg4, arg5);
    case sys_op_close: return sys_syscall_close(proc, arg1, arg2, arg3, arg4, arg5);
    case sys_op_read:  return sys_syscall_read(proc, arg1, arg2, arg3, arg4, arg5);
    case sys_op_write: return sys_syscall_write(proc, arg1, arg2, arg3, arg4, arg5);
    case sys_op_sleep: return sys_syscall_sleep(proc, arg1, arg2, arg3, arg4, arg5);
  }
...
function sys_syscall_init(proc, supports_op) {
  // TODO
  return 0
}
...
function sys_syscall_open(proc, pathptr, flags, mode) {
